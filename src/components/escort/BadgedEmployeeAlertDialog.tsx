...
interface BadgedEmployeeAlertDialogProps {
  isOpen: boolean;
  onClose: () => void;
  personName: string;
}

export const BadgedEmployeeAlertDialog: React.FC<BadgedEmployeeAlertDialogProps> = ({
  isOpen,
  onClose,
  personName
}) => {
          ...
          <AlertDialogHeader className="text-center space-y-4">
            ...
            <AlertDialogDescription className="text-sm text-gray-700 leading-relaxed space-y-4">
              <p className="font-semibold">
                The details you have entered belong to a badged employee.
              </p>
              
              <p>
                Please ensure that only non-badged individuals are added to the "Person Being Escorted" section.
              </p>
            </AlertDialogDescription>
          </AlertDialogHeader>
