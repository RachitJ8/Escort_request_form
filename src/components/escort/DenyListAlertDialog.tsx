...
interface DenyListAlertDialogProps {
  isOpen: boolean;
  onClose: () => void;
  personName: string;
}

export const DenyListAlertDialog: React.FC<DenyListAlertDialogProps> = ({
  isOpen,
  onClose,
  personName
}) => {
          ...
          <AlertDialogHeader className="text-center space-y-4">
            ...
            <AlertDialogDescription className="text-sm text-gray-700 leading-relaxed space-y-4">
              <p className="font-semibold">
                The provided details are associated with an individual on the Deny List.
              </p>
